...
Version  : 3.0.2
Release  : 10
URL      : https://github.com/tpm2-software/tpm2-tss/archive/3.0.2/tpm2-tss-3.0.2.tar.gz
Source0  : https://github.com/tpm2-software/tpm2-tss/archive/3.0.2/tpm2-tss-3.0.2.tar.gz
...
%prep
%setup -q -n tpm2-tss-3.0.2
cd %{_builddir}/tpm2-tss-3.0.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1605892482
...
cp %{_builddir}/tpm2-tss-3.0.2/LICENSE %{buildroot}/usr/share/package-licenses/tpm2-tss/af62924ad3089277c413ea767486f404ac159ce1
%make_install
