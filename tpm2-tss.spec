...
Source0  : https://github.com/tpm2-software/tpm2-tss/archive/2.4.0/tpm2-tss-2.4.0.tar.gz
...
%prep
%setup -q -n tpm2-tss-2.4.0
cd %{_builddir}/tpm2-tss-2.4.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1583973597
...
cp %{_builddir}/tpm2-tss-2.4.0/LICENSE %{buildroot}/usr/share/package-licenses/tpm2-tss/af62924ad3089277c413ea767486f404ac159ce1
%make_install
