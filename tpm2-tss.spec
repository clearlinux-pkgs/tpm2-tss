...
Version  : 3.0.1
Release  : 9
URL      : https://github.com/tpm2-software/tpm2-tss/archive/3.0.1/tpm2-tss-3.0.1.tar.gz
Source0  : https://github.com/tpm2-software/tpm2-tss/archive/3.0.1/tpm2-tss-3.0.1.tar.gz
...
%prep
%setup -q -n tpm2-tss-3.0.1
cd %{_builddir}/tpm2-tss-3.0.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1600884592
...
cp %{_builddir}/tpm2-tss-3.0.1/LICENSE %{buildroot}/usr/share/package-licenses/tpm2-tss/af62924ad3089277c413ea767486f404ac159ce1
%make_install
