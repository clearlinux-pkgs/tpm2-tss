...
Source0  : https://github.com/tpm2-software/tpm2-tss/archive/2.3.3/tpm2-tss-2.3.3.tar.gz
...
%prep
%setup -q -n tpm2-tss-2.3.3
cd %{_builddir}/tpm2-tss-2.3.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1582088430
...
cp %{_builddir}/tpm2-tss-2.3.3/LICENSE %{buildroot}/usr/share/package-licenses/tpm2-tss/af62924ad3089277c413ea767486f404ac159ce1
%make_install
