...
Version  : 3.0.0
Release  : 8
URL      : https://github.com/tpm2-software/tpm2-tss/archive/3.0.0/tpm2-tss-3.0.0.tar.gz
Source0  : https://github.com/tpm2-software/tpm2-tss/archive/3.0.0/tpm2-tss-3.0.0.tar.gz
...
%prep
%setup -q -n tpm2-tss-3.0.0
cd %{_builddir}/tpm2-tss-3.0.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1596643519
...
cp %{_builddir}/tpm2-tss-3.0.0/LICENSE %{buildroot}/usr/share/package-licenses/tpm2-tss/af62924ad3089277c413ea767486f404ac159ce1
%make_install
